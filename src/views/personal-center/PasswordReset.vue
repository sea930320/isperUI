<template>
  <div class="password-reset">
    ...
    <b-form @submit.prevent="updatePassword" class="cardDiv">
      <b-form-group label-cols="4" label-cols-lg="2" label="旧密码 *" :description="err['old-p']">
        <b-form-input
          type="password"
      ...
      <b-form-group label-cols="4" label-cols-lg="2" label="新密码 *" :description="err['new-p']">
        <b-form-input
          type="password"
      ...
      <b-form-group label-cols="4" label-cols-lg="2" label="密码确认 *" :description="err['new-p-c']">
        <b-form-input
          type="password"
