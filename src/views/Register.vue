          ...
          <b-col>
            <b-form @submit.prevent="register">
              <b-card-body class="text-center p-5">
                ...
                <b-form-group label-cols="4" label-cols-lg="2" label="邮箱" label-for="email">
                  <b-form-input type="email" v-model="user.email" placeholder="请输入邮箱" name="email"/>
                </b-form-group>
                <b-form-group label-cols="4" label-cols-lg="2" label="单位" label-for="company">
                  <b-form-select
                ...
                >
                  ...
                  />
                  <span class="err-label" v-if="notSameValidation()">Please input same Password</span>
                </b-form-group>
...
export default {
  ...
  methods: {
      ...
      this.$validator
        ...
        .then(response => {
          ...
          accountService.createAccount(this.user).then(() => {
            ...
            this.$toasted.success("Please wait until we review your profile");
            setTimeout(() => {
    ...
    notSameValidation() {
      if (this.user.password != this.user.passwordConfirmation) return true;
      return false;
    }
  }
};
