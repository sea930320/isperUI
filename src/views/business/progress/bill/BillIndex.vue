                ...
                <b-row>
                    <b-col sm="6">
                        <b-form-group label-cols-sm="4" label="章序号:" label-for="inputAdd1">
                            ...
                            <b-form-select id="inputAdd1" v-model="chapterSelected" :options="chapterOptions">
                                <template slot="first">
                    ...
                    <b-col sm="6">
                        <b-form-group label-cols-sm="4" label="章名:" label-for="inputAdd2">
                            <b-form-input id="inputAdd2" v-model="chapterSelected" ></b-form-input>
                        </b-form-group>
                    </b-col>
                </b-row>
                <b-row>
                    <b-col sm="6">
                        <b-form-group label-cols-sm="4" label="章序号:" label-for="inputAdd3">
                            <b-form-select id="inputAdd3" v-model="sectionSelected" :options="sectionOptions"></b-form-select>
                        </b-form-group>
                    </b-col>
                    <b-col sm="6">
                        <b-form-group label-cols-sm="4" label="章名:" label-for="inputAdd4">
                            <b-form-input id="inputAdd4" v-model="sectionSelected" ></b-form-input>
                        </b-form-group>
                    </b-col>
                </b-row>
                <b-row>
                    <b-col sm="6">
                        <b-form-group label-cols-sm="4" label="条文序号:" label-for="inputAdd5">
                            <b-form-input id="inputAdd5" v-model="partSelected"></b-form-input>
                        </b-form-group>
                    </b-col>
                    <b-col sm="6">
                        <b-form-group label-cols-sm="4" label="条文名称:" label-for="inputAdd6">
                            <b-form-input id="inputAdd6" v-model="partSelectedName" ></b-form-input>
                        </b-form-group>
                    </b-col>
                </b-row>
                    <b-row>
            ...
            init() {
                ...
                BillService.getBillName({
                    ...
                    .then(data => {
                        ...
                        var checkChapter=[];
                        var chapterListsData = {};

                        for (let i =0;i<this.bill_data.length;i++){
                            if (!(this.bill_data[i].chapter_number in checkChapter)){
                                checkChapter.push(this.bill_data[i].chapter_number);

//                                chapterListsData["text1"] = this.bill_data[i].chapter_title;
                                chapterListsData.text = this.bill_data[i].chapter_number;
                                chapterListsData.value = this.bill_data[i].chapter_title;
                                this.chapterOptions.push(chapterListsData);
                                checkChapter.push(this.bill_data[i].chapter_number);
                            }
                        }
