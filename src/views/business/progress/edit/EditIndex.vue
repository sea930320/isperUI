<template>
    <div class="edit-main-body">
            ...
            <div class="editor-container">
                <div class="w-100 bordered">
                    ...
                    <div v-if="edit_mode > 0 && sign_status > 0" class="sign">
                        ...
                        <a v-if="sign_status==2" class="btn-link mb-0" @click="sign_image_dialog=true" href="javascript:;">图片</a>
                    </div>
                </div>
            </div>
        ...
        <!-- image sign -->
        <b-modal v-model="sign_image_upload_dialog" :hide-header="true" :hide-footer="true" :centered="true">
            <upload
                :url="sign_image_url"
                :only-single="true"
                field="file"
