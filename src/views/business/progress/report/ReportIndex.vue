            ...
            <b-card-group>
                <b-card header-tag="header">
                    ...
                    <b-card-text>
                            ...
                            >
                                ...
                                <div slot="content" style="text-align: left;padding:20px">
                                    ...
                                    <p v-if="node.type === 5">
                                        <span>投票结果：</span>
                                        <span
                                            v-if="!node.vote_status || node.vote_status.length == 0"
                                        >无</span>
                                        <a
                                            v-else
                                            href="javascript:;"
                        ...
                        >
                            <div class="title">填写实验心得（提示：每个人只有一次填写机会，请慎重填写）</div>
                            <b-form-textarea
                                id="textarea"
                                placeholder="请填写心得！"
                                rows="3"
                ...
                <div class="result-detail-content" v-if="detail.type == 1">
                    <ul>
                        <li v-for="(record, index) in detail.data" :key="index">
                            ...
                            <p
                                v-else-if="record.ext.cmd == 'action_submit_experience'"
                            >{{record.ext.opt.content}}</p>
                                ...
                                <td>
                                    <div class="pr">
                                        ...
                                        <div class="sign-view-detail" v-show="signShow === index">
                                            ...
                                            <p
                                                v-else
                                                v-for="(sign, index1) in file.signs"
                                                :key="index1"
                                            >
...
export default {
    ...
    methods: {
        ...
        exportReport() {
            window.open(
                this.downloadUrl + "?business_id=" + this.$route.params.bid
            );
        },
        // 结束本次实验
        endBusiness() {
