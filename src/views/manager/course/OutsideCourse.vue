    ...
    <b-modal size="lg" hide-footer centered id="detailView" ref="detailView" title="查看详情">
      <b-container class="modalContainer" v-if="selectedRow">
        <b-row>
          ...
          <b-col lg="9" md="4" sm="4" class="text-left">课外学习主题：{{selectedRow.courseFullName}}</b-col>
        </b-row>
        <b-row>
          ...
          <b-col md="4" sm="12" class="text-left">指导者：{{selectedRow.teacherName}}</b-col>
        </b-row>
...
export default {
  ...
  methods: {
    queryGroupChanges() {
      this.run();
      CourseService.getOutsideCourseList({
        ...this.queryParam,
