...
//            });
        ...
        methods: {
            ...
            queryExperimentList() {
                ...
                this.run();
                businessService
                    .getBusinessListNoDel({...this.queryParam, ...this.queryDebounceParam})
                    .then(data => {
            ...
            deleteBusiness() {
                if (this.checkedItems.length > 0) {
                    ...
                    this.$toasted.error("请勾选要删除的事务");
                }
            },
            confirmDeleteBusiness(){
                businessService
                    .getBusinessDelete({data: JSON.stringify(this.checkedItems.map(it => it.id))}).then(() => {
