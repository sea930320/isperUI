        ...
        <b-row class="cardDiv">
            ...
            <b-col lg="5" md="6" sm="12" class="align-self-center">
                <b-button-group class="float-right" v-if="!isSuperFlag">
                    <b-button :size="template_size" class="styledBtn" variant="outline-primary" @click="publicProcess">
                        公开
                    </b-button>
                    <b-button :size="template_size" class="styledBtn" variant="outline-primary"
                              @click="unpublicProcess">不公开
                    </b-button>
                    <b-button :size="template_size" class="styledBtn" variant="outline-primary" @click="newProcess">
                        新建流程
                    </b-button>
                    <b-button
                            class="styledBtn"
                    ...
                    <b-button :size="template_size" class="styledBtn" variant="outline-primary" @click="shareClick">共享
                    </b-button>
                    <b-button :size="template_size" class="styledBtn" variant="outline-primary" @click="unshareClick">
                        取消共享
                    </b-button>
                </b-button-group>
            </b-col>
        ...
        <div class="cardDiv">
            <b-table :items="workflows.list" small hover :fields="columns" head-variant>
                ...
                <template slot="rend_ani_2" slot-scope="row">
                    ...
                    <div v-else>
                        <toggle-upload :item="row.item" :keyId="2"
                                       @uploadSuccess="uploadAnimationSuccess"></toggle-upload>
                    </div>
                </template>
