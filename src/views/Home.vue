                        ...
                        <b-card no-body class="opacity-bg">
                            <div class="d-flex justify-content-center p-3">
                                ...
                                <div class="login-btn px-2">
                                    <b-button to="login" variant="light" class="px-3">{{!isLoggedIn ? "登录" : "转到第一页"}}
                                    </b-button>
                                    <b-button v-if="!isLoggedIn" to="register" variant="light" class="px-3">注册
                                    </b-button>
                                </div>
                            </div>
                        </b-card>
                                        ...
                                        <b-list-group>
                                            ...
                                            >
                                                <b-link :to="post.link" style="color:black">
                                                    {{post.title}}&nbsp;&nbsp;<span class="badge badge-danger"
                                                                                    v-if="post.isNew==1">New</span>
                                                </b-link>
                                                <span v-if="post.created_at"
                                                      style="color: grey">{{post.created_at}}</span>
                                            </b-list-group-item>
                                        </b-list-group>
                                    </b-col>
                                </b-row>
...
<script>
    ...
    export default {
        ...
        methods: {
            queryAdvertisingList(){
                AdvertisingService
                    .getAdvertisingListHome({...this.queryParam})
                    .then(data => {
                        var today = new Date();
    ...
    //    http://localhost:8080/media/files/advertising/31.html
</script>
