    ...
    <transition name="ease">
      <div :class="modalClass" v-show="visible">
        <div class="modal-content">
          ...
          <div class="modal-header" v-if="showHead" ref="head"><slot name="header"><div class="modal-header-inner">{{ title }}</div></slot></div>
          <div class="modal-body scroll-bar"><slot></slot></div>
