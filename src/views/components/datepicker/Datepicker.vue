...
.date-picker{
	...
	background: url(./icon_canler.png) no-repeat right center;
  word-break: keep-all;
}
.input-wrapper{
...
.date-list .message.selected .bg {
	background-color: #3a7de0;
}
.date-list .message.selected span {
	color: #fff;
}
.date-list .message:not(.selected) .bg{
	transform: scale(0);
	opacity: 0;
}
.date-list .message:not(.selected):hover .bg {
	background-color: #3a7de0;
	transform: scale(1);
	opacity: .6;
}
.date-list .message:not(.selected):hover span {
	color: #fff;
}
.date-list .message .bg{
	height: 30px;
	width: 100%;
...
.week .preMonth, .date-list .preMonth, .week .nextMonth, .date-list .nextMonth {
	color: #ccc;
}
.week li, .date-list li {
	font-family: Roboto;
	width: 20px;
	height: 28px;
	text-align: center;
